...
<head>
  ...
  ======================================================= -->
  <link href="<c:url value="https://fonts.googleapis.com/css?family=Exo&display=swap" />" rel="stylesheet">
</head>
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">TERRA<span class="color-b">pp</span></a>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="agents-grid.html">Inmobiliarias</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <div class="title-link">
              <a href="agents-grid.html">Todas las Inmobiliarias
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">TERRA<span class="color-b">pp</span></h3>
            </div>
            <div class="w-body-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Phone </span> +52 1 331 807 4003</li>
                <li class="color-a">
                  <span class="color-text-a">Email </span> contacto@terrapp.com</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-4 section-md-t3">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">Otras ubicaciones</h3>
            </div>
            <div class="w-body-a">
              <ul class="list-unstyled">
                <li class="item-list-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">TERRA</span><span class="color-b">pp</span> Todos los derechos reservados.
            </p>
          </div>
          <div class="credits">
            <!--
