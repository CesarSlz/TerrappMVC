				...
				<div class="container-fluid">
					<div
						...
						<ul class="navbar-nav navbar-nav-left">
							<li class="nav-item ml-0 mr-5 d-lg-flex d-none"><a href="#"
								class="nav-link horizontal-nav-left-menu"><i
							...
							<li class="nav-item dropdown"><a
								...
								id="notificationDropdown" href="#" data-toggle="dropdown"> <i
									class="mdi mdi-bell mx-0"></i> <span class="count bg-success">2</span>
							</a>
								<div
							...
							<li class="nav-item dropdown"><a
								...
								id="messageDropdown" href="#" data-toggle="dropdown"> <i
									class="mdi mdi-email mx-0"></i> <span class="count bg-primary">4</span>
							</a>
								<div
									class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
							...
							<li class="nav-item dropdown"><a href="#"
								class="nav-link count-indicator "><i
									class="mdi mdi-message-reply-text"></i></a></li>
						...
						<div
							...
							<a class="navbar-brand brand-logo" href="/terrapp"><img
								src="/terrapp/resources/theme1/img/logo_verde.png" alt="TERRApp" /></a> <a
								class="navbar-brand brand-logo-mini" href="index.html"><img
								src="/terrapp/resources/theme1/img/logo_verde.png" alt="TERRApp" /></a>
						</div>
						<ul class="navbar-nav navbar-nav-right">
							...
							<li class="nav-item nav-profile dropdown"><a
								...
								id="profileDropdown"> <span class="nav-profile-name">Johnson</span>
									<span class="online-status"></span> <img
									src="images/faces/face28.png" alt="profile" />
							</a>
				...
				<div class="container">
					<ul class="nav page-navigation">
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
								class="mdi mdi-cube-outline menu-icon"></i> <span
						...
						<li class="nav-item"><a
							href="pages/forms/basic_elements.html" class="nav-link"> <i
						...
						<li class="nav-item"><a href="pages/charts/chartjs.html"
							class="nav-link"> <i class="mdi mdi-finance menu-icon"></i> <span
								class="menu-title">Charts</span> <i class="menu-arrow"></i>
						</a></li>
						<li class="nav-item"><a href="pages/tables/basic-table.html"
							class="nav-link"> <i class="mdi mdi-grid menu-icon"></i> <span
								class="menu-title">Tables</span> <i class="menu-arrow"></i>
						</a></li>
						<li class="nav-item"><a href="pages/icons/mdi.html"
							class="nav-link"> <i class="mdi mdi-emoticon menu-icon"></i>
								<span class="menu-title">Icons</span> <i class="menu-arrow"></i>
						</a></li>
						<li class="nav-item"><a href="#" class="nav-link"> <i
								class="mdi mdi-codepen menu-icon"></i> <span class="menu-title">Sample
						...
						<li class="nav-item"><a href="docs/documentation.html"
							class="nav-link"> <i
