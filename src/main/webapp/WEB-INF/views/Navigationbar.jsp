		...
		<div class="navbar-collapse collapse justify-content-center"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					class="btn btn-primary btn-lg" href="#signup" data-toggle="modal"
					data-target=".log-sign" style="color: #81BE1C">Ingresar</a></li>
			</ul>
		</div>
		<button type="button"
			...
			<div class="bs-example bs-example-tabs">
				...
				<li id="tab1" class=" active tab-style login-shadow "><a class="loginbtn"
					...
					<li id="tab2" class=" tab-style "><a href="#signup"
						data-toggle="tab" class="loginbtn">Sign Up</a></li>
